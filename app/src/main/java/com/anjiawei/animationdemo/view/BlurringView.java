package com.anjiawei.animationdemo.view;
...
import com.anjiawei.animationdemo.R;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBlurredView != null) {
            if (prepare()) {
                ...
                int offsetTop = (getHeight() - mBlurredView.getHeight()) / mDownsampleFactor;
                canvas.drawBitmap(mBlurredBitmap, 0, offsetTop, null);
                canvas.restore();
            }
